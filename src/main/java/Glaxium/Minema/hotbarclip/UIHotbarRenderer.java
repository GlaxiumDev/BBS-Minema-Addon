 ...
 * BBS-Minema-Addon -- self-contained (only touches Batcher2D/DrawContext/vanilla MC HUD
 * sprites), kept in this addon's own package rather than bbs-mod's. See HotbarClipRenderer for
